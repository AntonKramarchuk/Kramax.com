    ...
    return (
        <Container maxWidth="lg">
            <Box component="div" sx={{
                ...
                <Box component="div" sx={{
                    width: {xs: '100%', sm: '70%'},
                    background: `linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(${"/image/balcony.jpg"})`,
                    backgroundSize: 'cover',
                    padding: {xs: '30px 0', sm: '50px 0',md:'150px 0'}
                }}>
                    <Box component="div" sx={{
                        width: {xs: '100%', sm: '60%'},
                        height: '90%',
                        margin: {xs: '10% auto', sm: '0'},
                        paddingLeft: {sm: '10px', md: '15px'}
                    }}>
