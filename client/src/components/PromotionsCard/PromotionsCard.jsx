    ...
    return (
        <Card >
            <CardMedia sx={{width:'350px', height:'490px',position:'relative'}}
                       image={imageUrl}
                       alt="image">
                <CardContent sx={{background:backgroundColor,position:'absolute', top:'25%',right:'0',width:'70%',minHeight:'200px'}}>
                    <Link to='/' style={styles.link}><Typography sx={{fontSize: '30px',fontWeight:'200', color:'#172127',paddingBottom:'15px','&:hover': {textDecoration: 'underline'}}}>{title}</Typography></Link>
